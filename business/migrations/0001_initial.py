    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_template_id', models.CharField(blank=True, max_length=100, null=True)),
                ('onboarding_complete', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('motto', models.CharField(blank=True, max_length=255, null=True)),
                ('signature_type', models.CharField(choices=[('none', 'none'), ('text', 'text'), ('image', 'image')], default='none')),
